package site.rahoon.message.monolithic.common.global.utils
...
class TransactionConfig(
    ...
    override fun annotationDrivenTransactionManager(): PlatformTransactionManager = transactionManager
    ...
    private fun customTransactionAttributeSource(): TransactionAttributeSource {
        ...
        return object : TransactionAttributeSource {
            ...
            override fun isCandidateClass(clazz: Class<*>): Boolean = defaultSource.isCandidateClass(clazz)
        }
    }
}
