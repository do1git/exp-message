...
import site.rahoon.message.monolithic.common.test.assertSuccessPage
...
class MessageControllerIT(
    ...
    private fun sendMessage(
        ...
        return response
            .assertSuccess<MessageResponse.Create>(objectMapper, HttpStatus.CREATED) { data ->
    ...
    fun `채팅방별 메시지 목록 조회 - nextCursor로 페이지가 끊김 없이 이어짐`() {
        ...
        // then
        val page1 =
            page1Response.assertSuccessPage<MessageResponse.Detail>(objectMapper, HttpStatus.OK) { dataList, pageInfo ->
        ...
        // then
        val page2 =
            page2Response.assertSuccessPage<MessageResponse.Detail>(objectMapper, HttpStatus.OK) { dataList, pageInfo ->
                dataList.size shouldBe 2
                pageInfo.limit shouldBe 2
                pageInfo.nextCursor shouldNotBe null
                assertSortedByCreatedAtDescThenIdDesc(dataList)
        ...
        // then
        val page3 =
            page3Response.assertSuccessPage<MessageResponse.Detail>(objectMapper, HttpStatus.OK) { dataList, pageInfo ->
