# Latency 측정 테스트 실행 스크립트 (PowerShell)

Write-Host "========================================" -ForegroundColor Cyan
Write-Host " Realtime Message Latency Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# 반복 횟수 (기본값: 100)
$NUM_ITERATIONS = if ($env:NUM_ITERATIONS) { $env:NUM_ITERATIONS } else { "100" }
...
# 테스트 실행
Write-Host "Starting latency test..." -ForegroundColor Green
Write-Host ""
